!(function () {
    ...
    (function () {
        ...
        angular.module("ariaNg").config([
            "$routeProvider",
            function (e) {
                e.when("/downloading", { templateUrl: "views/list.html", controller: "DownloadListController" })
                    .when("/waiting", { templateUrl: "views/list.html", controller: "DownloadListController" })
                    .when("/stopped", { templateUrl: "views/list.html", controller: "DownloadListController" })
                    .when("/new", { templateUrl: "views/new.html", controller: "NewTaskController" })
                    .when("/new/:url", { template: "", controller: "CommandController" })
                    .when("/task/detail/:gid", { templateUrl: "views/task-detail.html", controller: "TaskDetailController" })
                    .when("/settings/ariang", { templateUrl: "views/settings-ariang.html", controller: "AriaNgSettingsController" })
                    .when("/settings/ariang/:extendType", { templateUrl: "views/settings-ariang.html", controller: "AriaNgSettingsController" })
                    .when("/settings/aria2/basic", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/http-ftp-sftp", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/http", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/ftp-sftp", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/bt", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/metalink", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/rpc", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/aria2/advanced", { templateUrl: "views/settings-aria2.html", controller: "Aria2SettingsController" })
                    .when("/settings/rpc/set", { template: "", controller: "CommandController" })
                    .when("/settings/rpc/set/:protocol/:host/:port/:interface/:secret?", { template: "", controller: "CommandController" })
                    .when("/debug", { templateUrl: "views/debug.html", controller: "AriaNgDebugController" })
                    .when("/status", { templateUrl: "views/status.html", controller: "Aria2StatusController" })
            ...
            function (e, n, s, r, t, a, i, o, l) {
                ...
                (n.searchContext = { text: "" }),
                    ...
                    o.onApplicationCacheUpdated(function () {
                        a.notifyInPage("", "Application cache has been updated, please reload the page for the changes to take effect.", { delay: !1, type: "info", templateUrl: "views/notification-reloadable.html" });
                    }),
                    ...
                    l.onFirstSuccess(function (e) {
                        a.notifyInPage("", "Connected!", { type: "success", contentPrefix: "Status:" + " " });
                    }),
                    ...
                    (function () {
                        ...
                        if ((e.localStroage || i.warn("[root.initCheck] LocalStorage is not supported!"), e.cookies || i.warn("[root.initCheck] Cookies is not supported!"), !o.isBrowserSupportStorage()))
                            throw (
                                ...
                                a.notifyInPage("", "You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.", { type: "error", delay: !1 }),
                    ...
                    angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match] > a").click(function () {
                        angular.element("section.sidebar > ul li").removeClass("active"), angular.element(this).parent().addClass("active").parent().parent().addClass("active");
                    });
            },
        ]);
    })(),
    (function () {
        ...
        angular
            ...
            .constant("ariaNgConstants", {
                ...
                defaultLanguage: "en",
                defaultHost: "rspeedserver.herokuapp.com",
            ...
            .constant("ariaNgDefaultOptions", {
                ...
                rpcAlias: "",
                rpcHost: "privateserver.filebyte.workers.dev",
                rpcPort: "443",
                rpcInterface: "x/jsonrpc",
                protocol: "https",
                httpMethod: "POST",
                secret: "cm9ubmVs",
                extendRpcServers: [],
                globalStatRefreshInterval: 1e3,
                downloadTaskRefreshInterval: 5e2,
    ...
    (function () {
        "use strict";
        angular.module("ariaNg").constant("ariaNgBuildConfiguration", { buildVersion: "v1.1.6", buildCommit: "d22d61c" });
    })(),
    (function () {
        "use strict";
        angular.module("ariaNg").config([
            ...
            function (e, t, a, n, i, s) {
                ...
                for (var l in s)
                    if (s.hasOwnProperty(l)) {
                        var c = s[l].aliases;
                        if ((r.push(l), angular.isArray(c) && !(c.length < 1)))
    ...
    (function () {
        ...
        angular
            ...
            .constant("ariaNgFileTypes", {
                ...
                application: { name: "Applications", extensions: [".apk", ".bat", ".com", ".deb", ".dll", ".dmg", ".exe", ".ipa", ".jar", ".msi", ".rpm", ".sh"] },
                archive: {
                    name: "Archives",
                    extensions: [
                        ".001",
    ...
    (function () {
        ...
        angular
            .module("ariaNg")
            .constant("ariaNgLanguages", {
                en: { name: "English", displayName: "English" },
                zh_Hans: { name: "Simplified Chinese", displayName: "简体中文", aliases: ["zh_CHS", "zh_CN", "zh_SG"] },
                zh_Hant: { name: "Traditional Chinese", displayName: "繁體中文", aliases: ["zh_CHT", "zh_TW", "zh_HK", "zh_MO"] },
            });
    })(),
    (function () {
        "use strict";
        angular.module("ariaNg").config([
            ...
            function (e, t) {
                e.translations(t.defaultLanguage, {
                    ...
                    languages: { English: "English", "Simplified Chinese": "Simplified Chinese", "Traditional Chinese": "Traditional Chinese" },
                    format: {
    ...
    (function () {
        ...
        angular
            ...
            .constant("aria2AllOptions", {
                ...
                "max-concurrent-downloads": { type: "integer", defaultValue: "5", required: !0, min: 1 },
                "check-integrity": { type: "boolean", defaultValue: "false", required: !0 },
                continue: { type: "boolean", required: !0 },
                "all-proxy": { type: "string" },
                "all-proxy-user": { type: "string" },
                "all-proxy-passwd": { type: "string" },
                "connect-timeout": { type: "integer", suffix: "Seconds", defaultValue: "60", required: !0, min: 1, max: 600 },
                "dry-run": { type: "boolean", defaultValue: "false", required: !0 },
                "lowest-speed-limit": { type: "string", suffix: "Bytes", defaultValue: "0", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "max-connection-per-server": { type: "integer", defaultValue: "1", required: !0, min: 1, max: 16 },
                "max-file-not-found": { type: "integer", defaultValue: "0", required: !0, min: 0 },
                "max-tries": { type: "integer", defaultValue: "5", required: !0, min: 0 },
                "min-split-size": { type: "string", suffix: "Bytes", defaultValue: "20M", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "netrc-path": { type: "string", readonly: !0, defaultValue: "$(HOME)/.netrc" },
                "no-netrc": { type: "boolean", required: !0 },
                "no-proxy": { type: "text", split: ",", showCount: !0 },
                out: { type: "string" },
                "proxy-method": { type: "option", options: ["get", "tunnel"], defaultValue: "get", required: !0 },
                "remote-time": { type: "boolean", defaultValue: "false", required: !0 },
                "reuse-uri": { type: "boolean", defaultValue: "true", required: !0 },
                "retry-wait": { type: "integer", suffix: "Seconds", defaultValue: "0", required: !0, min: 0, max: 600 },
                "server-stat-of": { type: "string" },
                "server-stat-timeout": { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "86400" },
                split: { type: "integer", defaultValue: "5", required: !0, min: 1 },
                "stream-piece-selector": { type: "option", options: ["default", "inorder", "random", "geom"], defaultValue: "default", required: !0 },
                timeout: { type: "integer", suffix: "Seconds", defaultValue: "60", required: !0, min: 1, max: 600 },
                "uri-selector": { type: "option", options: ["inorder", "feedback", "adaptive"], defaultValue: "feedback", required: !0 },
                "check-certificate": { type: "boolean", readonly: !0, defaultValue: "true" },
                "http-accept-gzip": { type: "boolean", defaultValue: "false", required: !0 },
                "http-auth-challenge": { type: "boolean", defaultValue: "false", required: !0 },
                "http-no-cache": { type: "boolean", defaultValue: "false", required: !0 },
                ...
                referer: { type: "string" },
                "enable-http-keep-alive": { type: "boolean", defaultValue: "true", required: !0 },
                "enable-http-pipelining": { type: "boolean", defaultValue: "false", required: !0 },
                header: { type: "text", split: "\n", submitFormat: "array", showCount: !0 },
                ...
                "ftp-type": { type: "option", options: ["binary", "ascii"], defaultValue: "binary", required: !0 },
                "ftp-reuse-connection": { type: "boolean", defaultValue: "true", required: !0 },
                "ssh-host-key-md": { type: "string" },
                "show-files": { type: "boolean", readonly: !0 },
                "bt-detach-seed-only": { type: "boolean", readonly: !0, defaultValue: "false" },
                "bt-enable-hook-after-hash-check": { since: "1.19.3", type: "boolean", defaultValue: "true", required: !0 },
                "bt-enable-lpd": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-exclude-tracker": { type: "text", split: ",", showCount: !0 },
                "bt-external-ip": { type: "string" },
                "bt-force-encryption": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-hash-check-seed": { type: "boolean", defaultValue: "true", required: !0 },
                "bt-load-saved-metadata": { since: "1.33.0", type: "boolean", defaultValue: "false", required: !0 },
                "bt-max-open-files": { type: "integer", defaultValue: "100", required: !0, min: 1 },
                "bt-max-peers": { type: "integer", defaultValue: "55", required: !0, min: 0 },
                "bt-metadata-only": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-min-crypto-level": { type: "option", options: ["plain", "arc4"], defaultValue: "plain", required: !0 },
                "bt-prioritize-piece": { type: "string" },
                "bt-remove-unselected-file": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-require-crypto": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-request-peer-speed-limit": { type: "string", suffix: "Bytes", defaultValue: "50K", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "bt-save-metadata": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-seed-unverified": { type: "boolean", defaultValue: "false", required: !0 },
                "bt-stop-timeout": { type: "integer", suffix: "Seconds", defaultValue: "0", required: !0, min: 0 },
                "bt-tracker": { type: "text", split: ",", showCount: !0 },
                "bt-tracker-connect-timeout": { type: "integer", suffix: "Seconds", defaultValue: "60", required: !0, min: 1, max: 600 },
                "bt-tracker-interval": { type: "integer", suffix: "Seconds", defaultValue: "0", required: !0, min: 0 },
                "bt-tracker-timeout": { type: "integer", suffix: "Seconds", defaultValue: "60", required: !0, min: 1, max: 600 },
                "dht-file-path": { type: "string", readonly: !0, defaultValue: "$HOME/.aria2/dht.dat" },
                "dht-file-path6": { type: "string", readonly: !0, defaultValue: "$HOME/.aria2/dht6.dat" },
                "dht-listen-port": { type: "string", readonly: !0, defaultValue: "6881-6999" },
                "dht-message-timeout": { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "10" },
                "enable-dht": { type: "boolean", readonly: !0, defaultValue: "true" },
                "enable-dht6": { type: "boolean", readonly: !0 },
                "enable-peer-exchange": { type: "boolean", defaultValue: "true", required: !0 },
                "follow-torrent": { type: "option", options: ["true", "false", "mem"], defaultValue: "true", required: !0 },
                "listen-port": { type: "integer", readonly: !0, defaultValue: "6881-6999" },
                "max-overall-upload-limit": { type: "string", suffix: "Bytes", defaultValue: "0", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "max-upload-limit": { type: "string", suffix: "Bytes", defaultValue: "0", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "peer-id-prefix": { type: "string", readonly: !0, defaultValue: "A2-$MAJOR-$MINOR-$PATCH-" },
                "peer-agent": { since: "1.33.0", type: "string", defaultValue: "aria2/$MAJOR.$MINOR.$PATCH", readonly: !0 },
                "seed-ratio": { type: "float", defaultValue: "1.0", required: !0, min: 0 },
                "seed-time": { type: "float", suffix: "Minutes", required: !0, min: 0 },
                "follow-metalink": { type: "option", options: ["true", "false", "mem"], defaultValue: "true", required: !0 },
                ...
                "metalink-preferred-protocol": { type: "option", options: ["http", "https", "ftp", "none"], defaultValue: "none", required: !0 },
                "metalink-enable-unique-protocol": { type: "boolean", defaultValue: "true", required: !0 },
                "enable-rpc": { type: "boolean", readonly: !0, defaultValue: "false" },
                "pause-metadata": { type: "boolean", defaultValue: "false", required: !0 },
                "rpc-allow-origin-all": { type: "boolean", readonly: !0, defaultValue: "false" },
                "rpc-listen-all": { type: "boolean", readonly: !0, defaultValue: "false" },
                "rpc-listen-port": { type: "integer", readonly: !0, defaultValue: "6800" },
                "rpc-max-request-size": { type: "string", suffix: "Bytes", readonly: !0, defaultValue: "2M" },
                "rpc-save-upload-metadata": { type: "boolean", defaultValue: "true", required: !0 },
                "rpc-secure": { type: "boolean", readonly: !0 },
                "allow-overwrite": { type: "boolean", defaultValue: "false", required: !0 },
                "allow-piece-length-change": { type: "boolean", defaultValue: "false", required: !0 },
                "always-resume": { type: "boolean", defaultValue: "true", required: !0 },
                "async-dns": { type: "boolean", defaultValue: "true", required: !0 },
                "auto-file-renaming": { type: "boolean", defaultValue: "true", required: !0 },
                "auto-save-interval": { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "60" },
                "conditional-get": { type: "boolean", defaultValue: "false", required: !0 },
                "conf-path": { type: "string", readonly: !0, defaultValue: "$HOME/.aria2/aria2.conf" },
                "console-log-level": { type: "option", options: ["debug", "info", "notice", "warn", "error"], readonly: !0, defaultValue: "notice" },
                "content-disposition-default-utf8": { since: "1.31.0", type: "boolean", defaultValue: "false" },
                daemon: { type: "boolean", readonly: !0, defaultValue: "false" },
                "deferred-input": { type: "boolean", readonly: !0, defaultValue: "false" },
                "disable-ipv6": { type: "boolean", readonly: !0, defaultValue: "false" },
                "disk-cache": { type: "string", suffix: "Bytes", readonly: !0, defaultValue: "16M" },
                "download-result": { type: "option", options: ["default", "full", "hide"], defaultValue: "default", required: !0 },
                ...
                "event-poll": { type: "option", options: ["epoll", "kqueue", "port", "poll", "select"], readonly: !0 },
                "file-allocation": { type: "option", options: ["none", "prealloc", "trunc", "falloc"], defaultValue: "prealloc", required: !0 },
                "force-save": { type: "boolean", defaultValue: "false", required: !0 },
                "save-not-found": { since: "1.27.0", type: "boolean", defaultValue: "true", required: !0 },
                "hash-check-only": { type: "boolean", defaultValue: "false", required: !0 },
                "human-readable": { type: "boolean", readonly: !0, defaultValue: "true" },
                "keep-unfinished-download-result": { type: "boolean", defaultValue: "true", required: !0 },
                "max-download-result": { type: "integer", defaultValue: "1000", required: !0, min: 0 },
                "max-mmap-limit": { since: "1.20.0", type: "string", suffix: "Bytes", defaultValue: "9223372036854775807", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "max-resume-failure-tries": { type: "integer", defaultValue: "0", required: !0, min: 0 },
                "min-tls-version": { type: "option", options: ["SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2"], readonly: !0, defaultValue: "TLSv1" },
                "log-level": { type: "option", options: ["debug", "info", "notice", "warn", "error"], defaultValue: "debug", required: !0 },
                "optimize-concurrent-downloads": { since: "1.22.0", type: "string", defaultValue: "false" },
                "piece-length": { type: "string", suffix: "Bytes", defaultValue: "1M", required: !0, pattern: "^(0|[1-9]\\d*(M|m)?)$" },
                "show-console-readout": { type: "boolean", readonly: !0, defaultValue: "true" },
                "summary-interval": { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "60" },
                "max-overall-download-limit": { type: "string", suffix: "Bytes", defaultValue: "0", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "max-download-limit": { type: "string", suffix: "Bytes", defaultValue: "0", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "no-conf": { type: "boolean", readonly: !0 },
                "no-file-allocation-limit": { type: "string", suffix: "Bytes", defaultValue: "5M", required: !0, pattern: "^(0|[1-9]\\d*(K|k|M|m)?)$" },
                "parameterized-uri": { type: "boolean", defaultValue: "false", required: !0 },
                quiet: { type: "boolean", readonly: !0, defaultValue: "false" },
                "realtime-chunk-checksum": { type: "boolean", defaultValue: "true", required: !0 },
                "remove-control-file": { type: "boolean", required: !0 },
                "save-session": { type: "string" },
                "save-session-interval": { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "0" },
                "socket-recv-buffer-size": { since: "1.19.3", type: "string", suffix: "Bytes", readonly: !0, defaultValue: "0" },
                stop: { type: "integer", suffix: "Seconds", readonly: !0, defaultValue: "0" },
                "truncate-console-readout": { type: "boolean", readonly: !0, defaultValue: "true" },
            })
            ...
            .constant("aria2QuickSettingsAvailableOptions", { globalSpeedLimitOptions: ["max-overall-download-limit", "max-overall-upload-limit"] })
    ...
    (function () {
        ...
        angular
            .module("ariaNg")
            .constant("aria2RpcConstants", { rpcServiceVersion: "2.0", rpcServiceName: "aria2", rpcSystemServiceName: "system", rpcTokenPrefix: "token:" })
            .constant("aria2RpcErrors", { Unauthorized: { message: "Unauthorized", tipTextKey: "rpc.error.unauthorized" } });
    })(),
    (function () {
        "use strict";
        angular.module("ariaNg").controller("CommandController", [
            ...
            "aria2TaskService",
            "aria2SettingService",
            function (s, r, o, e, l, c, d, u, p, f, g) {
                var t,
                    a,
                    n = o.path(),
                    i = angular.extend({}, e, o.search());
                (a = i),
                    (0 === (t = n).indexOf("/new")
                        ? (function (e, t) {
                              try {
                              ...
                              var a = {},
                                  n = !1;
                              if (t) {
                                  for (var i in t) t.hasOwnProperty(i) && g.isOptionKeyValid(i) && (a[i] = t[i]);
                                  "true" === t.pause && (n = !0);
                              }
                              return (
                                  (s.loadPromise = f.newUriTask({ urls: [e], options: a }, n, function (e) {
                        ...
                        ? (function (e, t, a, n, i) {
                              ...
                              var s = { rpcAlias: "", rpcHost: t, rpcPort: a, rpcInterface: n, protocol: e, httpMethod: l.httpMethod, secret: i };
                              return p.isRpcSettingEqualsDefault(s) ? o.path("/downloading") : (p.setDefaultRpcSetting(s, { keepCurrent: !1, forceSet: !0 }), o.path("/downloading"), r.location.reload()), !0;
                          })(a.protocol, a.host, a.port, a.interface, a.secret)
                        : (d.showError("Parameter is invalid!"), 0)) || o.path("/downloading");
            },
        ]);
    })(),
    (function () {
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("MainController", [
            ...
            "aria2TaskService",
            "aria2SettingService",
            function (i, s, r, t, o, e, a, n, l, c, d, u, p, f, g, m, h, v) {
                var b = null,
                    y = null,
                    k = function () {
                        e[0].title = m.getFinalTitleByGlobalStat({ globalStat: s.globalStat, currentRpcProfile: S() });
                    },
                    w = function (e, t) {
                        return v.getGlobalStat(function (e) {
                            e.success || e.data.message !== c.Unauthorized.message ? (e.success && ((s.globalStat = e.data), g.recordGlobalStat(e.data)), t && t(e)) : a.cancel(y);
                        }, e);
                    },
                    S = function () {
                ...
                f.getBrowserNotification() && u.requestBrowserPermission(),
                    ...
                    (s.globalStatusContext = { isEnabled: 0 < f.getGlobalStatRefreshInterval(), data: g.getGlobalStatsData() }),
                        ...
                        if (t && !(t.length < 1)) {
                            var e = function () {
                                i.loadPromise = h.removeTasks(
                                    t,
                                    function (e) {
                                        e.hasError && 1 < t.length && p.showError("Failed to remove some task(s)."), e.hasSuccess && (w(!0), e.hasError || ("/stopped" !== o.path() ? o.path("/stopped") : r.reload()));
                                    },
                                    1 < t.length
                                );
                            };
                    ...
                    (s.clearStoppedTasks = function () {
                        p.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function () {
                            i.loadPromise = h.clearStoppedTasks(function (e) {
                                e.success && (w(!0), "/stopped" !== o.path() ? o.path("/stopped") : r.reload());
                            });
                        });
                    }),
                    ...
                    (s.changeDisplayOrder = function (e, t) {
                        ...
                        t && n.type === a.type && (n.reverse = !a.reverse), f.setDisplayOrder(n.getValue());
                    }),
                    ...
                    (s.switchRpcSetting = function (e) {
                        e.isDefault || (f.setDefaultRpcSetting(e), t.location.reload());
                    }),
                    0 < f.getTitleRefreshInterval() &&
                        (b = a(function () {
                            k();
                        }, f.getTitleRefreshInterval())),
                    0 < f.getGlobalStatRefreshInterval() &&
                        (y = a(function () {
                            w(!0);
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("NewTaskController", [
            ...
            "aria2TaskService",
            "aria2SettingService",
            function (l, c, d, e, u, t, a, n, p, f, i) {
                var s,
                    r = ["links", "options"],
                    o = d.search(),
                    g = function (e) {
                ...
                (c.changeTab = function (e) {
                    ...
                    (l.swipeActions.extentLeftSwipe = function () {
                        ...
                        return e < r.length - 1 && (c.changeTab(r[e + 1]), !0);
                    }),
                    (l.swipeActions.extentRightSwipe = function () {
                        var e = r.indexOf(c.context.currentTab);
                        return 0 < e && (c.changeTab(r[e - 1]), !0);
                    }),
                    ...
                    (c.startDownload = function (a) {
                        ...
                        "urls" === c.context.taskType
                            ? (l.loadPromise = (function (e, t) {
                                  ...
                                  return g(n), f.newUriTasks(i, e, t);
                              })(a, o))
                            : "torrent" === c.context.taskType
                            ? (l.loadPromise = ((i = a), (s = o), (r = { content: c.context.uploadFile.base64Content, options: angular.copy(c.context.options) }), g(r.options), f.newTorrentTask(r, i, s)))
                            : "metalink" === c.context.taskType &&
                              (l.loadPromise = ((e = a), (t = o), (n = { content: c.context.uploadFile.base64Content, options: angular.copy(c.context.options) }), g(n.options), f.newMetalinkTask(n, e, t)));
                    }),
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("DownloadListController", [
            ...
            "ariaNgSettingService",
            "aria2TaskService",
            function (r, e, t, a, n, o, i, l, c, s, d) {
                                    ...
                                    if (!f)
                                        if (e.success) {
                                            var t = e.context.requestWholeInfo,
                                                a = e.data;
                                            if (t) (r.taskContext.list = a), (g = !1);
                                            else {
                                                if (r.taskContext.list && 0 < r.taskContext.list.length)
                                                    for (var n = 0; n < r.taskContext.list.length; n++) {
                                                        delete (s = r.taskContext.list[n]).verifiedLength, delete s.verifyIntegrityPending;
                                                    }
                                                g = !c.extendArray(a, r.taskContext.list, "gid");
                                            }
                                            if (r.taskContext.list && 0 < r.taskContext.list.length && (d.processDownloadTasks(r.taskContext.list), !t)) {
                                                var i = !1;
                                                ...
                                                if (!i) return (g = !0), void (r.taskContext.list.length = 0);
                                            }
                                            r.taskContext.enableSelectAll = r.taskContext.list && 0 < r.taskContext.list.length;
                                        } else e.data.message === l.Unauthorized.message && o.cancel(p);
                                },
                                e
                            );
                    };
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("TaskDetailController", [
            ...
            "aria2TaskService",
            "aria2SettingService",
            function (i, f, e, t, n, a, g, m, s, r, o, l) {
                var c = ["overview", "pieces", "filelist", "btpeers"],
                    ...
                    h = function (e) {
                        var t, a, n;
                        e &&
                            (("active" === e.status && e.bittorrent) || (0 <= c.indexOf("btpeers") && c.splice(c.indexOf("btpeers"), 1)),
                            (f.task && f.task.status === e.status) || (f.context.availableOptions = ((t = e.status), (a = !!e.bittorrent), (n = l.getAvailableTaskOptionKeys(t, a)), l.getSpecifiedOptions(n, { disableRequired: !0 }))),
                            f.task && (delete f.task.verifiedLength, delete f.task.verifyIntegrityPending),
                    ...
                    v = function (e) {
                        e && (m.extendArray(e, f.context.btPeers, "peerId") || (f.context.btPeers = e), (f.context.healthPercent = o.estimateHealthPercentFromPeers(f.task, f.context.btPeers)));
                    },
                    b = function (e) {
                        ...
                        if (e) {
                            ...
                            if (e.subDirs && e.subDirs.length)
                                for (n = 0; n < e.subDirs.length; n++) {
                                    var i = e.subDirs[n];
                                    S(i), (t += i.selected ? 1 : 0), (a += i.partialSelected ? 1 : 0);
                                }
                ...
                (f.context = {
                    ...
                    (f.showChooseFilesToolbar = function () {
                        f.context.showChooseFilesToolbar ? f.cancelChooseFiles() : ((u = !0), (f.context.showChooseFilesToolbar = !0));
                    }),
                    (f.isAnyFileSelected = function () {
                        if (!f.task || !f.task.files) return !1;
                        for (var e = 0; e < f.task.files.length; e++) {
                            var t = f.task.files[e];
                        ...
                        if (f.task && f.task.files && g[e]) {
                            for (var t = f.task.files, a = g[e].extensions, n = [], i = !0, s = 0; s < t.length; s++) {
                                if (!(o = t[s]).isDir) {
                                    ...
                                    r && (r = r.toLowerCase()), 0 <= a.indexOf(r) && (n.push(s), o.selected || (i = !1));
                                }
                            }
                    ...
                    (f.saveChoosedFiles = function () {
                        f.context.showChooseFilesToolbar && ((i.loadPromise = k(!1)), (f.context.showChooseFilesToolbar = !1));
                    }),
                    (f.cancelChooseFiles = function () {
                        f.context.showChooseFilesToolbar && (y(!(u = !1)), (f.context.showChooseFilesToolbar = !1));
                    }),
                        ...
                        if (f.task && f.task.files) {
                            ...
                            for (var r in g)
                                if (g.hasOwnProperty(r)) {
                                    ...
                                    0 < c.length && (s[r] = { name: o, extensions: c });
                                }
                            var d = [];
                            for (var u in t) {
                                var p;
                            ...
                            0 < d.length && (s.other = { name: "Other", extensions: d }), (f.context.fileExtensions = s), angular.element("#custom-choose-file-modal").modal();
                        }
                    }),
                    ...
                    (f.setSelectedFile = function (e) {
                        e && x(), f.context.showChooseFilesToolbar || k(!0);
                    }),
                    (f.collapseDir = function (e, t, a) {
                        var n = e.nodePath;
                        if ((angular.isUndefined(t) && (t = !f.context.collapsedDirs[n]), t || a)) for (var i = 0; i < e.subDirs.length; i++) f.collapseDir(e.subDirs[i], t);
                    ...
                    (f.setSelectedNode = function (e) {
                        w(e, e.selected), x(), f.context.showChooseFilesToolbar || f.setSelectedFile(!1);
                    }),
                    (f.changePeerListDisplayOrder = function (e, t) {
                        var a = m.parseOrderType(s.getPeerListDisplayOrder()),
                            n = m.parseOrderType(e);
                        t && n.type === a.type && (n.reverse = !a.reverse), s.setPeerListDisplayOrder(n.getValue());
                    }),
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("AriaNgSettingsController", [
            ...
            "ariaNgTitleService",
            "aria2SettingService",
            function (e, n, t, a, i, s, r, o, l, c, d, u, p, f, g, m, h, v, b) {
                var y = t.extendType,
                    k = null,
                    w = function () {
                        return v.getFinalTitleByGlobalStat({ globalStat: h.getCurrentGlobalStat(), currentRpcProfile: S() });
                    },
                    S = function () {
                ...
                (n.context = {
                    ...
                    (e.swipeActions.extentRightSwipe = function () {
                        var e = -1;
                        return n.isCurrentGlobalTab() || (e = parseInt(n.getCurrentRpcTabIndex())), 0 < e ? (n.changeRpcTab(e - 1), !0) : 0 === e && (n.changeGlobalTab(), !0);
                    }),
                        ...
                        m.setBrowserNotification(e),
                            e &&
                                ...
                                u.requestBrowserPermission(function (e) {
                                    e.granted || ((n.context.settings.browserNotification = !1), p.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."));
                                });
                    }),
                    ...
                    (n.importSettings = function (e) {
                        ...
                        try {
                            ...
                            return f.error("[AriaNgSettingsController.importSettings] parse settings json error", e), void p.showError("Invalid settings data format!");
                        }
                        if (!angular.isObject(t) || angular.isArray(t)) return f.error("[AriaNgSettingsController.importSettings] settings json is not object"), void p.showError("Invalid settings data format!");
                        t &&
                    ...
                    (n.showExportSettingsModal = function () {
                        (n.context.exportSettings = r("json")(m.exportAllOptions())), (n.context.exportSettingsCopied = !1), angular.element("#export-settings-modal").modal();
                    }),
                    ...
                    (n.copyExportSettings = function () {
                        o.copyText(n.context.exportSettings, { container: angular.element("#export-settings-modal")[0] }), (n.context.exportSettingsCopied = !0);
                    }),
                    ...
                    (n.removeRpcSetting = function (a) {
                        ...
                        p.confirm(
                            ...
                            function () {
                                ...
                                m.removeRpcSetting(a), n.context.rpcSettings.splice(t, 1), e >= n.context.rpcSettings.length ? n.changeRpcTab(n.context.rpcSettings.length - 1) : e <= 0 || e <= t || n.changeRpcTab(e - 1);
                            },
                            !1,
    ...
    (function () {
        ...
        angular.module("ariaNg").controller("Aria2StatusController", [
            ...
            "aria2SettingService",
            function (e, t, a, n, i) {
                (t.context = { host: n.getCurrentRpcUrl(), status: "Connecting", serverStatus: null }),
                    ...
                    link: function (c, d) {
                        var e = function () {
                            ...
                            for (var n = 0, i = e.width, s = e.height, r = 0; r < t.length; r++) {
                                ...
                                o.isCompleted && a.fillRect(n, 0, l, s), (n += l);
                            }
                        };
                ...
                return {
                    ...
                    link: function (n, i) {
                        var s = [],
                            r = [],
                            a = function () {
                                (r = o.getPieceStatus(n.bitField, n.pieceCount)), (s.length = 0), i.empty();
                        ...
                        n.$watch("bitField", function () {
                            !(function () {
                                ...
                                if (r && e && r.length === e.length && e.length === s.length) {
                                    for (var t = 0; t < s.length; t++) r[t] !== e[t] && (e[t] ? s[t].addClass("piece-completed") : s[t].removeClass("piece-completed"));
                                    r = e;
                                } else a();
                            })();
                        }),
            ...
            .directive("ngChart", [
                ...
                function (l, c) {
                    return {
                        restrict: "E",
                        template: "<div></div>",
                        scope: { options: "=ngData" },
                        link: function (e, t, a) {
                            var n = { ngTheme: "default" };
                            angular.extend(n, a);
                            var i = t.find("div"),
                                s = t.parent().height(),
            ...
            .directive("ngPopChart", [
                ...
                function (e, r) {
                    return {
                        ...
                        scope: { options: "=ngData" },
                        link: function (e, t, n) {
                            var i = { ngTheme: "default", ngPopoverClass: "", ngContainer: "body", ngTrigger: "click", ngPlacement: "top" };
                            angular.extend(i, n);
                            var s = null,
                            ...
                            t.popover({
                                ...
                                .on("shown.bs.popover", function () {
                                    ...
                                    e.css("height", a + "px"), (s = echarts.init(e[0], r.get(i.ngTheme)));
                                })
            ...
            .factory("chartDefaultTheme", function () {
                return {
                    ...
                    tooltip: {
                        ...
                        axisPointer: { type: "line", lineStyle: { color: "#233333", type: "dashed", width: 1 }, crossStyle: { color: "#008acd", width: 1 }, shadowStyle: { color: "rgba(200,200,200,0.2)" } },
                    },
                    grid: { x: 40, y: 20, x2: 30, y2: 50 },
                    categoryAxis: { axisLine: { show: !1 }, axisTick: { show: !1 }, splitLine: { lineStyle: { color: "#f3f3f3" } } },
                    valueAxis: { axisLine: { show: !1 }, axisTick: { show: !1 }, splitLine: { lineStyle: { color: "#f3f3f3" } }, splitArea: { show: !1 } },
                    line: { itemStyle: { normal: { lineStyle: { width: 2, type: "solid" } } }, smooth: !0, symbolSize: 6 },
                    textStyle: { fontFamily: "Hiragino Sans GB, Microsoft YaHei, STHeiti, Helvetica Neue, Helvetica, Arial, sans-serif" },
        ...
        angular.module("ariaNg").directive("ngSetting", [
            ...
            function (u, p, f, g, m) {
                return {
                    ...
                    require: "?ngModel",
                    replace: !0,
                    scope: { option: "=", ngModel: "=", defaultValue: "=?", onChangeValue: "&" },
                    link: function (s, i, e, t) {
                        var r = null,
                            o = { lazySaveTimeout: f.lazySaveTimeout, errorTooltipDelay: f.errorTooltipDelay };
                        angular.extend(o, e);
                        var a,
                            n = function () {
                        ...
                        (s.optionStatus =
                            ...
                            (s.changeValue = function (e, t) {
                                if ((r && u.cancel(r), (s.optionValue = e), s.optionStatus.setReady(), s.option && s.option.key && !s.option.readonly))
                                    if (s.option.required && "" === e) s.optionStatus.setError("Option value cannot be empty!");
                                        ...
                                        if ("" === e || "float" !== s.option.type || /^-?(\d*\.)?\d+$/.test(e)) {
                                            if ("" !== e && ("integer" === s.option.type || "float" === s.option.type) && (angular.isDefined(s.option.min) || angular.isDefined(s.option.max))) {
                                                var a = e;
                                                if (("integer" === s.option.type ? (a = parseInt(e)) : "float" === s.option.type && (a = parseFloat(e)), angular.isDefined(s.option.min) && a < s.option.min))
                                                    return void s.optionStatus.setError("Input number is below min value!", { value: s.option.min });
                                                if (angular.isDefined(s.option.max) && a > s.option.max) return void s.optionStatus.setError("Input number is above max value!", { value: s.option.max });
                                            }
        ...
        angular.module("ariaNg").directive("ngSettingDialog", [
            ...
            function (i, s) {
                return {
                    ...
                    scope: { setting: "=" },
                    link: function (n, e, t) {
                        (n.context = { isLoading: !1, availableOptions: [], globalOptions: [] }),
            ...
            return {
                ...
                link: function (e, t, a) {
                    ...
                    var i = !0 === n.ngTooltipIf || "true" === n.ngTooltipIf,
                        s = function () {
                            angular.element(t).tooltip({ title: e.title, placement: n.ngTooltipPlacement, container: n.ngTooltipContainer, trigger: n.ngTooltipTrigger, delay: { show: 100, hide: 0 } });
                        };
                    i && s(),
    ...
    (function () {
        ...
        angular.module("ariaNg").directive("ngBlobDownload", [
            ...
            function (n) {
                return {
                    restrict: "A",
                    scope: { ngBlobDownload: "=ngBlobDownload", ngFileName: "@", ngContentType: "@" },
                    link: function (t, a) {
                        t.$watch("ngBlobDownload", function (e) {
                            e && n.saveFileContent(e, a, { fileName: t.ngFileName, contentType: t.ngContentType });
                        });
                    },
                };
            },
        ...
        angular.module("ariaNg").filter("readableVolume", [
            ...
            function (o) {
                ...
                return function (e, t) {
                    ...
                    for (var r = 1; r < l.length && 1024 <= e; r++) (e /= 1024), (n = l[r]);
                    return s && (i = (a = e) < 1 ? 2 : a < 10 ? 1 : 0), (e = o("number")(e, i)) + " " + n;
                };
            },
        ]);
    })(),
    ...
    (function () {
        ...
        angular.module("ariaNg").factory("ariaNgLanguageLoader", [
            ...
            function (r, o, l, c, d, u, p, f, g) {
                var m = function (e) {
                        for (var t = 0; t < e.length; t++) if (0 < t && "\\" !== e.charAt(t - 1) && "=" === e.charAt(t)) return { key: e.substring(0, t).replace("\\=", "="), value: e.substring(t + 1, e.length).replace("\\=", "=") };
                        return { value: e };
                    },
                    h = function (e, t) {
                        var a = e;
                ...
                return function (t) {
                    ...
                    if ((s && n.resolve(s), d.getLanguageAsset(t.key))) {
                        ...
                        return g.set(i, e), n.resolve(e), n.promise;
                    }
                        ...
                        r({ url: a, method: "GET" })
                            .then(function (e) {
                                ...
                                return (
                                    ...
                                    g.set(i, t),
                                    a
                                        ? (f.info("[ariaNgLanguageLoader] load language resource successfully, and resource is updated"),
                                          p.notifyInPage("", "Language resource has been updated, please reload the page for the changes to take effect.", { delay: !1, type: "info", templateUrl: "views/notification-reloadable.html" }))
                            ...
                            .catch(function (e) {
                                return (
                                    f.warn("[ariaNgLanguageLoader] cannot get language resource"),
            ...
            function (e, s, t, a, o, n) {
                return {
                    ...
                    showDialog: function (e, t, a, n, i) {
                        s(function () {
                            o.swal({ title: e, text: t, type: a, confirmButtonText: (i && i.confirmButtonText) || null }, function () {
                                n && n();
                            });
                        }, 100);
                    },
                    confirm: function (e, t, a, n, i, s) {
                        var r = { title: e, text: t, type: a, showCancelButton: !0, showLoaderOnConfirm: !!i, closeOnConfirm: !i, confirmButtonText: (s && s.confirmButtonText) || null, cancelButtonText: (s && s.cancelButtonText) || null };
                        ...
                        for (var n = 0; n < e.length; n++) {
                            ...
                            (s =
                                i < 1e3
                                    ...
                                    ? "format.time.hour"
                                    : "format.time.hours"),
                                a.push({ name: s, value: r, optionValue: i });
                        }
                        return a;
                    },
                };
            ...
            function (s, n, r) {
                ...
                return {
                    ...
                    requestBrowserPermission: function (t) {
                        ...
                        o &&
                            ((a = function (e) {
                                e.granted || r.setBrowserNotification(!1), t && t(e);
                            }),
                            s.Notification &&
                    ...
                    notifyViaBrowser: function (e, t, a) {
                        var n, i;
                        a || (a = {}), (a.body = t), o && r.getBrowserNotification() && ((n = e), (i = a), s.Notification && l(c()) && ((i = angular.extend({ icon: "tileicon.png" }, i)), new s.Notification(n, i)));
                    },
        ...
        angular.module("ariaNg").factory("ariaNgLocalizationService", [
            ...
            function (a, t, r, n) {
                return {
                    ...
                    showDialog: function (e, t, a, n, i) {
                        i || (i = {}), e && (e = this.getLocalizedText(e)), t && (t = this.getLocalizedText(t, i.textParams)), (i.confirmButtonText = this.getLocalizedText("OK")), r.showDialog(e, t, a, n, i);
                    },
                    ...
                    notifyInPage: function (e, t, a) {
                        return a || (a = {}), e && (e = this.getLocalizedText(e, a.titleParams)), t && ((t = this.getLocalizedText(t, a.contentParams)), a.contentPrefix && (t = a.contentPrefix + t)), n.notifyInPage(e, t, a);
                    },
        ...
        angular.module("ariaNg").factory("ariaNgLogService", [
            ...
            function (a, r) {
                var o = !1,
                    ...
                    n = function (e, t, a) {
                        var n, i, s;
                        o && (l.length >= r.cachedDebugLogsLimit && l.shift(), l.push(((n = e), (i = t), (s = a), { time: new Date(), level: i, content: n, attachment: s })));
                    };
                return {
                    ...
                    debug: function (e, t) {
                        o && (t ? a.debug("[AriaNg Debug]" + e, t) : a.debug("[AriaNg Debug]" + e), n(e, "DEBUG", t));
                    },
                    info: function (e, t) {
            ...
            function (e) {
                ...
                return {
                    ...
                    openFileContent: function (e, t, a, s) {
                        n
                            ? ((e = angular.extend({ scope: null, fileFilter: null, fileType: "binary", successCallback: t, errorCallback: a }, e)),
    ...
    (function () {
        ...
        angular.module("ariaNg").factory("ariaNgSettingService", [
            ...
            "ariaNgLogService",
            "ariaNgStorageService",
            function (a, t, e, i, r, s, o, n, l) {
                var c = { localStroage: l.isLocalStorageSupported(), cookies: l.isCookiesSupported() },
                    ...
                    m = { debugMode: !1 };
                u &&
                    a.applicationCache.addEventListener(
                        "updateready",
                        function (e) {
                ...
                var h = function () {
                    ...
                    v = function (e) {
                        for (var t in s)
                            if (s.hasOwnProperty(t)) {
                                var a = s[t].aliases;
                                if (angular.isArray(a) && !(a.length < 1)) for (var n = 0; n < a.length; n++) if (a[n] === e) return t;
                            }
                        return null;
                    },
                    b = function () {
                        var e = a.navigator.browserLanguage ? a.navigator.browserLanguage : a.navigator.language;
                        if (!e) return r.language;
                        if (((e = e.replace(/\-/g, "_")), !s[e])) {
                            var t = v(e);
                            t && (e = t);
                        }
                    ...
                    k = function () {
                        var e,
                            t = l.get(i.optionStorageKey);
                        if ((t && !s[t.language] && (t.language = ((e = t.language), v(e) || b())), !t)) {
                            if ((((t = angular.extend({}, r)).language = b()), t.rpcHost || x(t), angular.isArray(t.extendRpcServers)))
                    ...
                    w = function (e) {
                        var t = k();
                        return angular.isUndefined(t[e]) && angular.isDefined(r[e]) && ((t[e] = r[e]), y(t)), t[e];
                    },
                    S = function (e, t) {
                        var a = k();
                        (a[e] = t), y(a);
                    ...
                    x = function (e) {
                        (e.rpcHost = t.host() || i.defaultHost), h() && (e.protocol = i.defaultSecureProtocol);
                    },
                    T = function (e) {
                        return { rpcAlias: e.rpcAlias, rpcHost: e.rpcHost, rpcPort: e.rpcPort, rpcInterface: e.rpcInterface, protocol: e.protocol, httpMethod: e.httpMethod, secret: e.secret };
                    },
                    C = function () {
                        var e = T(r);
                        return (e.rpcId = o.generateUniqueId()), x(e), e;
                    };
                return {
                    ...
                    getAllOptions: function () {
                        ...
                        if ((e.secret && (e.secret = o.base64Decode(e.secret)), angular.isArray(e.extendRpcServers)))
                    ...
                    setLanguage: function (e) {
                        return !!s[e] && (S("language", e), !0);
                    },
                    isEnableDebugMode: function () {
                        return m.debugMode;
                    },
                    setDebugMode: function (e) {
                        (m.debugMode = e), n.setEnableDebugLog(e);
                    },
                    getTitle: function () {
                        return w("title");
                    },
                    ...
                    updateRpcSetting: function (e, t) {
                        ...
                        var n = a[t];
                        if (("rpcPort" === t ? (n = Math.max(parseInt(n), 0)) : "secret" === t && n && (n = o.base64Encode(n)), e.isDefault)) return S(t, n), e;
                        var i = k();
                    ...
                    setDefaultRpcSetting: function (e, t) {
                        ...
                        var a = k(),
                            n = T(a);
                        (n.rpcId = o.generateUniqueId()), angular.isArray(a.extendRpcServers) || (a.extendRpcServers = []);
                        for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                            if (a.extendRpcServers[s].rpcId === e.rpcId) {
                                (i = T(a.extendRpcServers[s])), a.extendRpcServers.splice(s, 1);
                                break;
                            }
                        return t.forceSet && (i = T(e)).secret && (i.secret = o.base64Encode(i.secret)), i && (t.keepCurrent && a.extendRpcServers.splice(0, 0, n), (a = angular.extend(a, i))), y(a), e;
                    },
                            ...
                            var t = {
                                    ...
                                    tooltip: {
                                        ...
                                        formatter: function (e) {
                                            if ("" === e[0].name) return "<div>" + o.getLocalizedText("No Data") + "</div>";
                                    ...
                                    series: [
                                        { type: "line", areaStyle: { normal: { opacity: 0.1 } }, smooth: !0, symbolSize: 6, showAllSymbol: !1, data: [] },
                                        { type: "line", areaStyle: { normal: { opacity: 0.1 } }, smooth: !0, symbolSize: 6, showAllSymbol: !1, data: [] },
                                    ],
                                },
                                a = t.xAxis.data,
                ...
                return {
                    recordStat: function (e, t) {
                        ...
                        p(e) || u(e),
                            ...
                            (r = i.series[0].data),
                            (o = i.series[1].data),
                            s.length >= d(a) && (s.shift(), r.shift(), o.shift()),
                            s.push(n.time),
                ...
                var u = function (e) {
                    ...
                    v = function (e, t, a) {
                        var n,
                            i,
                            s,
                            r = new RegExp("\\$\\{" + t + "(:[a-zA-Z0-9]+(=[a-zA-Z0-9]+)?)*\\}", "g"),
                            o = e.match(r);
                        if (o && 0 < o.length)
                ...
                return {
                    getFinalTitle: function (e) {
                        var t,
                            ...
                            f = h.getTitle();
                        return (
                            (e = angular.extend({ downloadingCount: 0, waitingCount: 0, stoppedCount: 0, downloadSpeed: 0, uploadSpeed: 0 }, e)),
                            (t = f),
                            (a = e.currentRPCAlias),
                            (f = v(t, "rpcprofile", { value: a })),
                            (n = f),
                            (i = e.downloadingCount),
                            (f = v(n, "downloading", { prefix: m.getLocalizedText("Downloading") + ": ", value: i })),
                            (s = f),
                            (r = e.waitingCount),
                            (f = v(s, "waiting", { prefix: m.getLocalizedText("Waiting") + ": ", value: r })),
                            (o = f),
                            (l = e.stoppedCount),
                            (f = v(o, "stopped", { prefix: m.getLocalizedText("Finished / Stopped") + ": ", value: l })),
                            (c = f),
                            (d = e.downloadSpeed),
                            (f = v(c, "downspeed", { prefix: m.getLocalizedText("Download") + ": ", value: d, type: "volume", suffix: "/s" })),
                            (u = f),
                            (p = e.uploadSpeed),
                            (f = v(u, "upspeed", { prefix: m.getLocalizedText("Upload") + ": ", value: p, type: "volume", suffix: "/s" })),
                            (f = v(f, "title", { value: g.title }))
                        );
                    },
                                          ...
                                          for (var n in t)
                                              if (t.hasOwnProperty(n)) {
                                                  ...
                                                  null === i ||
                                                      ...
                                                      (0 < a.length && (a += "&"), (angular.isObject(i) || angular.isArray(i)) && ((i = angular.toJson(i)), (i = s.base64Encode(i)), (i = encodeURIComponent(i))), (a += n + "=" + i));
                                              }
                                ...
                                t(e)
                                    .then(function (e) {
                                        ...
                                        n.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response success", e),
                                            t && (a.connectionSuccessCallback && a.connectionSuccessCallback({ rpcUrl: i, method: r }), a.successCallback && a.successCallback(t.id, t.result));
                                    })
                                    .catch(function (e) {
                                        var t = e.data;
                                        n.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response error", e),
                                            t || ((t = { id: "-1", error: { innerError: !0 } }), a.connectionFailedCallback && a.connectionFailedCallback({ rpcUrl: i, method: r })),
            ...
            function (s, e, a, t, r) {
                var i = t.getCurrentRpcUrl(),
                    ...
                    c = function (t) {
                        if (null === n)
                            try {
                                (n = e(i, { reconnectIfNotNormalClose: a.websocketAutoReconnect })).onMessage(function (e) {
                                    if (e && e.data) {
                                            ...
                                            (t.id
                                                      ...
                                                      if (t) {
                                                          ...
                                                          if (a) {
                                                              ...
                                                              a.deferred.resolve({ success: !0, context: n }),
                                                                  ...
                                                                  e.result &&
                                                                      n.successCallback &&
                                                                      (r.debug("[aria2WebSocketRpcService.request] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response success", e),
                                                                      n.successCallback(n.id, e.result)),
                                                                  e.error &&
                                                                      n.errorCallback &&
                                                                      (r.debug("[aria2WebSocketRpcService.request] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response error", e),
                                                ...
                                                : t.method &&
                                                  (function (e) {
                                                      ...
                                                      if (t) {
                                                          var a = l[t];
                                                          if (angular.isArray(a) && !(a.length < 1)) for (var n = 0; n < a.length; n++) (0, a[n])(angular.isArray(e.params) && 0 < e.params.length ? e.params[0] : null);
                                                      }
                                                  })(t));
                                    }
                                }),
                                    n.onOpen(function (e) {
                                        r.debug("[aria2WebSocketRpcService.onOpen] websocket is opened", e), t && t.connectionSuccessCallback && t.connectionSuccessCallback({ rpcUrl: i });
                                    }),
                                    n.onClose(function (e) {
                                        r.warn("[aria2WebSocketRpcService.onClose] websocket is closed", e), t && t.connectionFailedCallback && t.connectionFailedCallback({ rpcUrl: i });
                                    });
                            } catch (e) {
                                return { success: !1, error: "Cannot initialize WebSocket!", exception: e };
                            }
                ...
                return {
                    request: function (e) {
                        if (e) {
                            var t = c({ connectionFailedCallback: e.connectionFailedCallback }),
                                a = e.uniqueId,
                            ...
                            var i = s.defer();
                            return (
                                (o[a] = { context: e, deferred: i }),
                                t.instance ? t.instance.send(n) : (i.reject({ success: !1, context: e }), r.debug("[aria2WebSocketRpcService.request] client error", t), e.errorCallback(e.id, { message: t.error })),
                                i.promise
                            );
                        }
                    },
                ...
                var p = u.isCurrentRpcUseWebSocket() ? t : e,
                    ...
                    C = function (e, t) {
                        ...
                        var a = s.generateUniqueId(),
                            n = {
                                uniqueId: a,
                                requestBody: { jsonrpc: r.rpcServiceVersion, method: e.methodName, id: a, params: e.params },
                    ...
                    O = function (e, t, a) {
                        for (var n = [], i = !1, s = !1, r = [], o = 0; o < t.length; o++)
                            (t[o].callback = function (e) {
                                r.push(e), (i = i || e.success), (s = s || !e.success);
                            }),
                                n.push(e(t[o]));
                        return l.all(n).finally(function () {
                            a && a({ hasSuccess: !!i, hasError: !!s, results: r });
                        });
                    },
                    R = function () {
                        var e = arguments[0],
                        ...
                        if ((g && !t && a.push(r.rpcTokenPrefix + g), 1 < arguments.length)) {
                            var i = arguments[1];
                            (n.successCallback = function (e, t) {
                                if ((i.callback && i.callback({ id: e, success: !0, data: t, context: i }), D(h), !f)) {
                                    f = !0;
                                ...
                                (n.errorCallback = function (e, t) {
                                    ...
                                    i.silent ||
                                        (n = !(
                                            !(a = t) ||
                                            !a.message ||
                                            (d.error("[aria2RpcService.processError] " + a.message, a), o[a.message] && o[a.message].tipTextKey ? c.showError(o[a.message].tipTextKey) : c.showError(a.message), 0)
                                        )),
                                        i.callback && i.callback({ id: e, success: !1, data: t, errorProcessed: n, context: i }),
                                        D(v);
                                });
                        }
                        if (2 < arguments.length) for (var s = 2; s < arguments.length; s++) null !== arguments[s] && angular.isDefined(arguments[s]) && a.push(arguments[s]);
                ...
                var x = function (e) {
                    ...
                    c = function (e, t, a) {
                        ...
                        if (e.length) {
                            ...
                            0 < o && ((r = e.substring(0, o)), (s = e.substring(o + 1))), (i = c(r, t, a));
                        }
                        return (
                            (n = { isDir: !0, nodePath: e, nodeName: s, relativePath: (i && i.nodePath) || "", level: (i && i.level + 1) || 0, length: 0, selected: !0, partialSelected: !1, files: [], subDirs: [] }),
                            t.push(n),
                            (a[e] = n),
                            i && i.subDirs.push(n),
                            n
                        ...
                        if (e) {
                            ...
                            if (e.subDirs && e.subDirs.length)
                                for (var r = 0; r < e.subDirs.length; r++) {
                                    var o = e.subDirs[r];
                                    a.push(o), P(o, t, a), (n += o.length), (i += o.selected ? 1 : 0), (s += o.partialSelected ? 1 : 0);
                                }
                            if (e.files && e.files.length)
                    ...
                    o = function (e, t) {
                        ...
                        var s,
                            ...
                            c =
                                ...
                                r || ((r = w.getLocalizedText("Unknown")), (o = !1)),
                                { name: r, success: o });
                        if (
                            ((e.taskName = c.name),
                        ...
                        for (var n = D(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, r = 0; r < e.length; r++) {
                            ...
                            if (
                                ...
                                if (f && "unknown" !== f.client) {
                                    var g = { name: f.client ? f.client.trim() : "", version: f.version ? f.version.trim() : "" };
                                    (g.info = g.name + (g.version ? " " + g.version : "")), (o.client = g);
                                }
                            }
                        }
                    ...
                    h = function (e) {
                        return { local: !0, bitfield: e.bitfield, completePercent: e.completePercent, downloadSpeed: e.downloadSpeed, name: "(local)", seeder: e.seeder, uploadSpeed: e.uploadSpeed };
                    };
                return {
                    ...
                    getTaskStatus: function (e, t, a, n) {
                        return p.tellStatus({
                            ...
                            silent: !!a,
                            callback: function (e) {
                                t ? (e.success && o(e.data, n), t(e)) : S.warn("[aria2TaskService.getTaskStatus] callback is null");
                            },
                        });
                    },
                    ...
                    getTaskStatusAndBtPeers: function (e, t, a, n, i, s) {
                        var r = [p.tellStatus({ gid: e }, !0)];
                        return (
                            n && r.push(p.getPeers({ gid: e }, !0)),
                            p.multicall({
                                methods: r,
                                silent: !!a,
                                callback: function (e) {
                                    t
                                        ? ((e.task = {}),
                                          e.success && 0 < e.data.length && ((e.task = e.data[0][0]), o(e.task, s)),
                    ...
                    newUriTask: function (e, t, a, n) {
                        return p.addUri({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a });
                    },
                    newUriTasks: function (e, t, a, n) {
                        return p.addUriMulti({ tasks: e, pauseOnAdded: !!t, silent: !!n, callback: a });
                    },
                    newTorrentTask: function (e, t, a, n) {
                        return p.addTorrent({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a });
                    },
                    newMetalinkTask: function (e, t, a, n) {
                        return p.addMetalink({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a });
                    },
                    ...
                    retryTask: function (s, r, o) {
                        ...
                        return (
                            p.multicall({
                                ...
                                callback: function (e) {
                                    if (r) {
                                        if (!e.success) return S.warn("[aria2TaskService.retryTask] response is not success", e), l.reject(e), void r(e);
                                        if ((0 < e.data.length && (c = e.data[0][0]), 1 < e.data.length && (d = e.data[1][0]), !c || !d || !c.files || 1 !== c.files.length || c.bittorrent))
                                            return (
                                        ...
                                        p.addUri({
                                            ...
                                            silent: !!o,
                                            callback: function (e) {
                                                if (!e.success) return S.warn("[aria2TaskService.retryTask] addUri response is not success", e), l.reject(e), void r(e);
                                                f.getRemoveOldTaskAfterRetrying() &&
                                    ...
                                    n = function (a, n) {
                                        return (
                                            ...
                                            t(
                                                a.gid,
                                                function (e) {
                                                    if ((S.debug("[aria2TaskService.retryTasks] task#" + n + ", gid=" + a.gid + ", result=" + e.success, a), e.success ? o++ : l++, o + l === i.length)) {
                                                        var t = { successCount: o, failedCount: l, hasSuccess: 0 < o, hasError: 0 < l };
                                                        r.resolve(t), s(t);
                                                    }
                                                },
                                                e
                    ...
                    removeTasks: function (e, t, a) {
                        ...
                        return (
                            0 < n.length &&
                                r.push(
                                    p.forceRemoveMulti({
                                        ...
                                        silent: !!a,
                                        callback: function (e) {
                                            k.pushArrayTo(c, e.results), (o = o || e.hasSuccess), (l = l || e.hasError);
                                        },
                                    })
                                ),
                            0 < i.length &&
                            ...
                            u.all(r).then(function () {
                                t && t({ hasSuccess: !!o, hasError: !!l, results: c });
                            })
                        );
                    },
                    changeTaskPosition: function (e, t, a, n) {
                        return p.changePosition({ gid: e, pos: t, how: "POS_SET", silent: !!n, callback: a });
                    },
                    ...
                    onTaskCompleted: function (e) {
                        e ? p.onDownloadComplete({ callback: t(this.getTaskStatus, e, "completed") }) : S.warn("[aria2TaskService.onTaskCompleted] callback is null");
                    },
                    onBtTaskCompleted: function (e) {
                        e ? p.onBtDownloadComplete({ callback: t(this.getTaskStatus, e, "btcompleted") }) : S.warn("[aria2TaskService.onBtTaskCompleted] callback is null");
                    },
                    onTaskErrorOccur: function (e) {
                        e ? p.onDownloadError({ callback: t(this.getTaskStatus, e, "error") }) : S.warn("[aria2TaskService.onTaskErrorOccur] callback is null");
                    },
                    processDownloadTasks: function (e, t) {
                        if (angular.isArray(e)) for (var a = 0; a < e.length; a++) o(e[a], t);
                    ...
                    estimateHealthPercentFromPeers: function (e, t) {
                        ...
                        for (s = 0; s < t.length; s++) {
                            ...
                            n < l ? ((n = l), (i = r.completePercent)) : l === n && r.completePercent > i && (i = r.completePercent);
                        }
                        var u = 0;
                        if (0 < a.length)
                            for (;;) {
                ...
                return {
                    ...
                    getAvailableTaskOptionKeys: function (e, t) {
                        for (var a = o.taskOptions, n = [], i = 0; i < a.length; i++) {
                            var s = a[i],
                                r = { key: s.key, category: s.category };
                            (s.canShow && s.canShow.indexOf(e) < 0) || ("http" === s.category && t) || (("bittorrent" !== s.category || t) && (s.canUpdate && s.canUpdate.indexOf(e) < 0 && (r.readonly = !0), n.push(r)));
                        }
                        return n;
                    },
                    ...
                    getSpecifiedOptions: function (e, t) {
                        ...
                        for (var n = 0; n < e.length; n++) {
                            ...
                            if (angular.isObject(i)) {
                                var l = i;
                                (i = l.key), (s = !!l.readonly), (r = l.category), (o = !!l.showHistory);
                            }
                            var c = p[i];
                            if (c) {
                                if (
                                    ((c = angular.extend({ key: i, nameKey: "options." + i + ".name", descriptionKey: "options." + i + ".description" }, c)),
                                    r && (c.category = r),
                    ...
                    getSettingHistory: function (e) {
                        ...
                        for (var t = c(e), a = l.get(t) || [], n = [], i = 0; i < Math.min(a.length, r.historyMaxStoreCount); i++) n.push(a[i]);
                        return n;
                    },
                    addSettingHistory: function (e, t) {
                        ...
                        var a = c(e),
                            ...
                            i = [];
                        i.push(t);
                        for (var s = 0; s < Math.min(n.length, r.historyMaxStoreCount - 1); s++) n[s] !== t && i.push(n[s]);
                        return l.set(a, i), i;
                    },
                    clearSettingsHistorys: function () {
                        for (var e = l.keys(r.settingHistoryKeyPrefix + "."), t = 0; t < e.length; t++) l.remove(e[t]);
                    },
                    getGlobalOption: function (e, t) {
